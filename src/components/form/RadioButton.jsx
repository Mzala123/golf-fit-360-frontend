        ...
        <div className="grid gap-4 md:grid-cols-2">
            {
                ...
                <label htmlFor={name + index} key={option.value} className="font-Poppins_Bold flex flex-col justify-between gap-2 border border-gray-200 rounded-lg p-3 cursor-pointer">
